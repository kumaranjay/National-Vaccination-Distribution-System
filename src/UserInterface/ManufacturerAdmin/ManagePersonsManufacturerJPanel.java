 ...
 * @author Danisha
 */
public class ManagePersonsManufacturerJPanel extends javax.swing.JPanel {

    /**
     * Creates new form ManagePersonsManufacturerJPanel
     */
    ...
    public ManagePersonsManufacturerJPanel(JPanel userProcessContainer, CDCSystem system, Enterprise enterprise, UserAccount account) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(submitButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 610, -1, -1));
        ...
        add(deleteButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 230, 81, -1));
        ...
        add(viewButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(910, 230, 81, -1));
        ...
        add(refreshButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 230, -1, -1));

        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel10.setText("Contact No.");
        add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 520, -1, -1));

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel9.setText("Address2");
        add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 460, -1, -1));
        ...
        add(adress1JTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 460, 203, -1));
        ...
        add(adress1JTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 460, 203, -1));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 60, 831, 140));
        ...
        add(emailIdJTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 510, 203, -1));
        ...
        add(contactNoJTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 510, 203, -1));

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel7.setText("Add Person");
        add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 280, -1, -1));

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel6.setText("First Name");
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 340, -1, -1));
        ...
        add(passwordJTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 400, 203, -1));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel4.setText("Last Name");
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 340, -1, -1));

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel8.setText("Address1");
        add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 460, -1, -1));
        ...
        add(usernameJTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 400, 203, -1));

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel5.setText("Password");
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 400, -1, -1));
        ...
        add(lastNameJTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 340, 203, -1));
        ...
        add(firstNameJTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 340, 203, -1));
        ...
        add(backButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 630, -1, -1));

        add(organizationComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 560, 203, -1));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel2.setText("Organization Type");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 560, -1, -1));
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        ...
        if (!(firstName.isEmpty()) && !(lastName.isEmpty()) && !(userName.isEmpty()) && !(password.isEmpty())) {
            ...
            if (organization.getName().equals(Organization.Type.Finance.getValue())) {
                role = new ManufacturerFinanceRole();
            }
        ...
        if (selectedRow >= 0) {
            ...
            if (option == JOptionPane.YES_OPTION) {
                ...
                for (UserAccount ua : enterprise.getUserAccountDirectory().getUserAccountList()) {
                    if (ua == account) {
                        enterprise.getEmployeeDirectory().getEmployeeList().remove(ua.getEmployee());
                        organization1.getEmployeeDirectory().getEmployeeList().remove(ua.getEmployee());
                        enterprise.getUserAccountDirectory().getUserAccountList().remove(ua);
                        organization1.getUserAccountDirectory().getUserAccountList().remove(ua);
